...
export default function SignInScreen() {
  ...
  const handleBreadcrumbPress = (index: number) => console.log(`Breadcrumb ${index} clicked`);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.breadcrumbContainer}>
        <Breadcrumb breadcrumbs={['Auth', 'Sign In']} onPress={handleBreadcrumbPress} />
      </View>

      <View style={styles.formContainer}>
        <TextInput placeholder="Account" style={styles.input} value={email} onChangeText={setEmail} />
        ...
        <Text style={styles.linkText}>
          ...
          <Text style={styles.linkOrange} onPress={() => router.push('/signUp')}>
            Sign up
          </Text>
        </Text>
